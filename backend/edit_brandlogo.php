...
<body>
    ...
    <section id="dashboard">
        ...
        if (isset($_POST['btn_save'])) {
            ...
            if ($result) {
                header("location: admin_brandlogo.php");
                move_uploaded_file($edit_apple_icon_temp, "../assets/img/$edit_apple_icon");
                move_uploaded_file($edit_shortcut_icon_temp, "../assets/img/$edit_shortcut_icon");
            } else {
                echo
                "<script> 
            
                alert('Error');
                window.location.href='admin_brandlogo.php';
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="col-12">
                <label for="appleIcon" class="form-label">Nav Brand Logo</label>
                <img width="90" height="90" alt="<?php echo $apple_icon ?>" src="../assets/img/<?php echo $apple_icon ?>">
                <input type="file" class="form-control" id="appleIcon" name="form_apple">
            </div>
            <div class="col-12 mb-3">
                <label for="shortcutIcon" class="form-label">Footer Brand Logo</label>
                <img width="90" height="90" alt="<?php echo $shortcut_icon ?>" src="../assets/img/<?php echo $shortcut_icon ?>">
