...
<body>
    ...
    <section id="dashboard">
        ...
        <h1 class="welcome-text">First Sub Carousel</h1>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    if (isset($_POST['btn_save'])) {
                        ...
                        $sql = "INSERT INTO carousel_2 (img) VALUE ('$image')";

                        $result = mysqli_query($con, $sql);

                        if ($result) {
                            header("location: firstsub-carousel.php");
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    ...
                    if (isset($_GET['delete'])) {
                        $del = $_GET['delete'];
                        $sql = "DELETE FROM carousel_2 WHERE id ='$del'";
                        $result = mysqli_query($con, $sql);
